<script lang="ts">
    ...
    import CategorySelect from "$lib/components/new_product/molecules/CategorySelect.svelte";
...
<form onsubmit={handleSubmit}>
    <div class="pt-8">
        <div class="grid grid-cols-3 gap-6">
            ...
            <div class="relative w-48 h-48  mx-5">
                ...
                <button
                    type="button"
                    onclick={openFilePicker}
                    class="mt-2 text-sm text-tx-secondary hover:text-white transition-colors"
                >
        ...
        <div class="pt-8 flex flex-row gap-4">
            ...
            <button
                type="button"
                onclick={() => goto(`/my_products/${product.id}`)}

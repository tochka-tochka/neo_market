...
<div class="pt-8">
    <div class="flex flex-row justify-between items-start pb-6">
        ...
        <div>
                <button
                    type="button"
                    onclick={() => goto(`/my_products/${product.id}/edit`)}
    ...
    <div class="grid grid-cols-[220px_1fr] gap-8 pb-8">
        <div class="w-[220px] h-[220px] bg-neutral mx-5">
        ...
        <div class="flex flex-col justify-between gap-6 ml-10">
            <div>
                <p class="font-Manrope font-light text-xl text-tx-secondary pb-2">Название</p>

...
from src.models.product import Product, SKU, ProductImage, SKUImage, InvoiceItem, Invoice
...
class SKUSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = SKU
        fields = ['id', 'product_id', 'name', 'price', 'cost_price', 'discount', 'active_quantity', 'images', 'characteristics']
